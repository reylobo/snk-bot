...
# You can replace this with whatever you want, or leave it as it is. 
# This is where the bot stores its users' Steam IDs.
...
# Set this to False if you want users to be able to just enter the last part of
# their URL, e.g. "!steamid robinwalker" instead of "!steamid http://steamcommunity.com/id/robinwalker/".
# I highly recommend keeping this set to True. Setting it to false just confuses a bunch of players into
# accidentally entering their Steam nicknames.
# e.g. Jim tries typing "!steamid Jim", and the bot ends up finding "http://steamcommunity.com/id/Jim/"
# (who is someone else), and Jim can't figure out why the bot can never find his lobbies.
...
# Rate limiting: each user can only ask the bot for this many things per day. This stops you from breaking
# the daily request limit for your Steam API key.
maxDailyRequestsPerUser = 60
maxTotalDailyRequests = 45000

# Image spam limiting: How often the bot will post the public_profile_instructions.jpg and
# steam_url_instructions.jpg instruction images for people setting up their profiles
